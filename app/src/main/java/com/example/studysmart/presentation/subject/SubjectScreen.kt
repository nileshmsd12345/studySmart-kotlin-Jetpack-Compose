...
private fun SubjectScreen(
    ...
    val isFABExtended by remember {
        derivedStateOf {
            lisState.firstVisibleItemIndex == 0
        }
    }
    ...
    DeleteDialog(
        ...
        bodyText = "Are you sure you want to delete this subject? All related tasks and sessions will be permanently removed.This action can not be undone",
        onDismissRequest = {
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            tasksList(
                emptyListText = "You don't have any completed tasks.\n Click the the checkbox on completion of task",
            ...
            studySessionList(
                ...
                sessionList = state.recentSessions,
